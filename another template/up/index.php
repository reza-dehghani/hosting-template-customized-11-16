...
$allow_types=array("jpg","gif","png","zip","rar","txt");
...
<title><?php echo $websitename; ?>| Powred By 11-16.ir</title>
...
<form action="<?=$_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data" name="11-16">
<table align="center" class="table">
	<tr>
		<td class="table_header" colspan="2"><img src="http://11-16.ir/my/brand.png" alt="www.11-16.ir"> </td>
	</tr>
...
<table class="table" style="border:0px;" align="center">
	<tr>
		<td><div class="copyright">&copy; <a>Powred by <b>11-16.ir</b></a></div></td>
	</tr>
</table>
</body>
</html>